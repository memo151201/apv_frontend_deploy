  ...
  const {msg}=alerta
   ...
   return (
         <>
            ...
            <div>
              <h1 className="text-indigo-600 font-black text-6xl">Inicia Sesion y Admnistra tus {""}  <span className ="text-black">pacientes</span> </h1>
           </div>
                 ...
                 <form onSubmit={handleSubmit}>
                    <div className="my-5">
                     ...
                     <div>
                       ...
                       <input className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" type="text" placeholder="Tu password"
                        value={password}
