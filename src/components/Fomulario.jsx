  ...
  return (
    ...
    <>     <h2 className='font-black text-3xl text-center'>
      ...
      <p className='text-xl mt-5 mb-10 text-center'>
          Anade tus pacientes y {''}<span className='text-indigo-600 font-bold'>Administralos</span>
        </p>
     <form className='bg-white py-10 px-5 mg-10 mb-10 lg:mb-0  shadow-md rounded-md'
     onSubmit={handleSubmit}>
          <div className='mb-5'>
           ...
           <input type='submit'  value={id?"Guardar Cambios":"Agregar paciente"} className=' text-white bg-indigo-600 w-full p-3 uppercase font-bold hover:bg-indigo-600 cursor-pointer transition-colors'/>
      </form>
